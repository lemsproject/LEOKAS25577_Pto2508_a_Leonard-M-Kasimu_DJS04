...
/**
 * PodcastProvider component to wraps children in a context with state for
 * searching, filtering, sorting and paginating podcast data.
...
export function PodcastProvider({ children, initialPodcasts = [] }) {
  ...
  useEffect(() => {
    ...
    const calculatePageSize = () => {
      ...
      // Desktop: calculate how many cards fit based on a 250px card width and 20px gap
      const cardWidth = 250;
      const gap = 20;
